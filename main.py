...
with st.form("my_form"):
    ...
    if submitted:
        model = tf.keras.models.load_model("C:\\Users\\DELL\\Desktop\\dental final\\keras_Model.h5", compile=False)
        class_names = open("C:\\Users\\DELL\\Desktop\\dental final\\labels.txt", "r").readlines()
